...
const validScss = readFileSync('./__tests__/scss-valid.scss', 'utf-8');
const invalidScss = readFileSync('./__tests__/scss-invalid.scss', 'utf-8');
...
describe('SCSS', () => {
  ...
  describe('flags warnings with invalid scss', () => {
    ...
    it('correct warning text', () => {
      assert.equal(result.results[0].warnings[0].text, 'Expected variable to be kebab-case (private variables must start with _)');
    });
